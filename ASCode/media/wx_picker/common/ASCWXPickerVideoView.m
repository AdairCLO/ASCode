...
@interface ASCWXPickerVideoView ()
...
@implementation ASCWXPickerVideoView
...
- (void)onTap
{
    ...
    [self.delegate videoViewPlaybackButtonDidClick:self];
}
...
- (BOOL)isPlaying
{
    return self.playbackImageView.hidden;
}
...
- (void)onPlayToEndNotification:(NSNotification *)notification
{
    ...
    else
    {
        ...
        [self.delegate videoViewDidPlayToEnd:self];
    }
}
